...
- "We gathered all the [documents](/blog/in-english/824.document/) needed for the meeting."
- "회의에 필요한 모든 서류를 모았어요."

### distribute

'[distribute](/blog/in-english/741.distribute/)'는 모은 것을 **나누어 주거나 배포**하는 뜻으로, 'collect'와는 반대되는 개념이에요. 수집한 것을 여러 곳이나 사람에게 나누어 주는 상황에서 사용해요.

- "They distributed the collected donations to the [victims](/blog/in-english/985.victim/)."
