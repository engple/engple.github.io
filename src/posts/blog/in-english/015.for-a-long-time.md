...
<ul data-interactive-list>
  <li data-interactive-item>
    <span data-toggler>"옛날부터 여기서 일하고 있어."</span>
    <span data-answer>"I've been working here for a long time."</span>
  </li>
  <li data-interactive-item>
    <span data-toggler>"옛날부터 여행을 가고 싶었어."</span>
    <span data-answer>"I've wanted to travel for a long time."</span>
  </li>
  <li data-interactive-item>
    <span data-toggler>"옛날부터 여기 살고 있어."</span>
    <span data-answer>"I've been living here for a long time."</span>
  </li>
  <li data-interactive-item>
    <span data-toggler>"옛날부터 이 가게에서 장을 봐왔어."</span>
    <span data-answer>"I've been shopping at this store for a long time."</span>
  </li>
  <li data-interactive-item>
    <span data-toggler>"옛날부터 이 노래를 좋아했어."</span>
    <span data-answer>"I've liked this song for a long time."</span>
  </li>
  <li data-interactive-item>
    <span data-toggler>"옛날부터 이 영화가 보고 싶었어."</span>
    <span data-answer>"I've wanted to watch this movie for a long time."</span>
  </li>
  <li data-interactive-item>
    <span data-toggler>"사라(Sarah)를 오랜만에 봤어. 언젠가 커피 마시면서 근황 얘기 좀 나눠야겠다."</span>
    <span data-answer>"I haven't seen Sarah for a long time. We should catch up <a href="/blog/in-english/504.over-coffee/">over coffee</a> sometime."</span>
  </li>
  <li data-interactive-item>
    <span data-toggler>"버스를 한참 기다렸는데. 놓친 것 같아."</span>
    <span data-answer>"I've been <a href="blog/in-english/377.wait-for/">waiting for</a> the bus for a long time. I think I missed it."</span>
  </li>
</ul>
...
'[in a flash](/blog/in-english/813.in-a-flash/)'는 **"순식간에" 또는 "눈 깜짝할 사이에"** 라는 뜻이에요. 이 표현은 **매우 빠르게 일어나는 행동이나 사건**을 설명할 때 사용해요. "for a long time"과는 대조적으로, 아주 짧은 시간을 강조해요.
...
'[at a snail's pace](/blog/in-english/814.at-a-snail's-pace/)'는 **"매우 천천히" 또는 "달팽이 속도로"** 라는 의미예요. 이 표현은 **극도로 느린 속도나 진행 상황**을 묘사할 때 사용해요. "for a long time"과 비슷한 맥락에서 오랜 시간이 걸리는 상황을 강조하지만, 더 부정적인 뉘앙스를 가져요.

- "The [construction](/blog/in-english/858.construction/) project is moving at a snail's paca, [frustrating](/blog/in-english/378.frustrating/) local residents."
