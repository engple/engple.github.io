...
'suffer a [loss](/blog/in-english/722.loss/)'는 "패배를 겪다" 또는 "손실을 입다"라는 뜻이에요. defeat와 비슷하게 지거나 실패하는 상황에서 사용되지만, defeat가 좀 더 직접적으로 '패배시키다'라면, suffer a loss는 '패배를 당하다'에 가까워요.
