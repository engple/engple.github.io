...
'It's about time'은 **"이제 때가 됐다" 또는 "드디어 할 때가 됐다"** 라는 뜻이에요. 이 표현은 **어떤 일이 일어나거나 행동을 취해야 할 시기가 이미 지났거나 늦었다는 것을 나타내며, 종종 짜증이나 조급함**을 표현해요. 주로 누군가가 뭔가를 하는 데 너무 오래 걸렸거나, 어떤 일이 일어나기를 오래 기다렸을 때 사용해요.
