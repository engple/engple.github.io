...
이 표현은 여러 가지 방법이나 시도를 해봤지만, **모두 실패하고 효과가 없었다**는 상황에서 사용해요. 즉, 마지막까지 해봤지만 소용이 없었다는 뉘앙스를 담고 있죠.
...
오늘은 "**다른 방법은 다 안 됐어**"라는 뜻을 가진 영어 표현 "**Nothing else worked**"에 대해 알아봤어요. 여러 시도를 했지만 다 실패했을 때 이 표현을 떠올려보면 좋겠죠? 😊
