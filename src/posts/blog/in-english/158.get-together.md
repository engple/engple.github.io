...
<ul data-interactive-list>
  <li data-interactive-item>
    <span data-toggler>이번 주말에 모여서 커피 마시며 이야기해요.</span>
    <span data-answer>Let's get together this weekend and <a href="/blog/in-english/021.catch-up-on/">catch up</a> over coffee.</span>
  </li>
  <li data-interactive-item>
    <span data-toggler>대학 친구들과 매년 한 번은 꼭 모이려고 해요.</span>
    <span data-answer>My old college friends and I <a href="/blog/in-english/117.try-to/">try to</a> get together <a href="/blog/in-english/167.at-least/">at least</a> once a year.</span>
  </li>
  <li data-interactive-item>
    <span data-toggler>언제 한 번 모여야 해요. 만난지 너무 오래됐어요!</span>
    <span data-answer>We should get together sometime. It's been ages!</span>
  </li>
  <li data-interactive-item>
    <span data-toggler>우리 집에서 모이는거 어때요?</span>
    <span data-answer>Why don't we get together at my place?</span>
  </li>
  <li data-interactive-item>
    <span data-toggler>마지막으로 이렇게 모두 모인 게 언제였죠?</span>
    <span data-answer>When was the last time all of us got together like this?</span>
  </li>
  <li data-interactive-item>
    <span data-toggler>우리 밴드는 매주 화요일 밤에 모여서 연습해요.</span>
    <span data-answer>My band gets together every Tuesday night to <a href="/blog/in-english/247.practice/">practice</a>.</span>
  </li>
  <li data-interactive-item>
    <span data-toggler>프로젝트 아이디어를 내기 위해 모여야 해요.</span>
    <span data-answer>We should get together and <a href="/blog/in-english/227.brainstorm/">brainstorm</a> some ideas for the project.</span>
  </li>
  <li data-interactive-item>
    <span data-toggler>예전에는 매주 금요일 밤에 게임을 하려고 모였어요.</span>
    <span data-answer>We <a href="/blog/in-english/143.used-to/">used to</a> get together every Friday night for game night.</span>
  </li>
  <li data-interactive-item>
    <span data-toggler>다음 주에 점심 먹으러 한 번 모일까요?</span>
    <span data-answer>Maybe we could get together for lunch sometime next week?</span>
  </li>
</ul>
